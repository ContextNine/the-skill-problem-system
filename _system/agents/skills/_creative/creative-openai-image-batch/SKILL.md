...
```bash
node _system/agents/skills/_creative/creative-openai-image-batch/scripts/generate-images.mjs --manifest prompts.json --out renders/images --dry-run
```
...
```bash
node _system/agents/skills/_creative/creative-openai-image-batch/scripts/generate-images.mjs \
