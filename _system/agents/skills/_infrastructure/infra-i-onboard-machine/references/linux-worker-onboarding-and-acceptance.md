...
```bash
launcher_installer="$(vault root)/_system/agents/skills/_infrastructure/infra-i-manage-claude-provider-routes/scripts/install-claude-provider-launchers.sh"
...
```bash
secret_service_script="$(vault root)/_system/agents/skills/_infrastructure/infra-i-onboard-machine/scripts/linux_secret_service.py"
...
```bash
WORKSPACE_SKILL_DIR="$(vault root)/_system/agents/skills/_infrastructure/infra-i-sync-code-workspaces"
...
```bash
watchdog_installer="$(vault root)/_system/agents/skills/_infrastructure/infra-i-onboard-machine/scripts/linux_optional_watchdogs.py"
