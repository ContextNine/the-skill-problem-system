...
```bash
python3 "$(vault root)/_system/agents/skills/_infrastructure/infra-i-onboard-machine/scripts/bootstrap_worker_mac.py" status MACHINE_ID
python3 "$(vault root)/_system/agents/skills/_infrastructure/infra-i-onboard-machine/scripts/bootstrap_worker_mac.py" seed MACHINE_ID
python3 "$(vault root)/_system/agents/skills/_infrastructure/infra-i-onboard-machine/scripts/bootstrap_worker_mac.py" seed MACHINE_ID
```
...
```bash
python3 "$(vault root)/_system/agents/skills/_infrastructure/infra-i-onboard-machine/scripts/bootstrap_worker_mac.py" finish MACHINE_ID
python3 "$(vault root)/_system/agents/skills/_infrastructure/infra-i-onboard-machine/scripts/bootstrap_worker_mac.py" finish MACHINE_ID
```
...
```bash
python3 "$(vault root)/_system/agents/skills/_infrastructure/infra-i-onboard-machine/scripts/bootstrap_worker_mac.py" verify MACHINE_ID --json
```
