---
name: infra-i-update-fleet-coding-tools
...
6. For an installed macOS nightly app, follow [[_system/agents/skills/_infrastructure/infra-i-update-fleet-coding-tools/references/native-artifact-updates|Native Artifact Updates]]. Use its configured GitHub nightly channel and the same exact version resolved above.
