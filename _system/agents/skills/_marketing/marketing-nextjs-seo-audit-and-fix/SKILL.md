...
1. Read `_system/agents/_package/instance/skills/config/marketing-nextjs-seo-audit-and-fix/README.md`; use configured targets when present.
...
6. Hand GTM, GA4, Consent Mode, and data-layer work to [[_system/agents/skills/_marketing/marketing-google-marketing-measurement/SKILL|Google Marketing Measurement]]. Hand managed campaign URLs to [[_system/agents/skills/_marketing/marketing-manage-utm-tracking-links/SKILL|Manage UTM Tracking Links]].
