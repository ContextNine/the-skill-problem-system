...
1. `$witan-xlsx` for every workbook read, trace, edit, calculation, lint, and render.
2. `$witan-read-source` when local PDF, DOCX, PPTX, HTML, or Markdown evidence must feed assumptions.
