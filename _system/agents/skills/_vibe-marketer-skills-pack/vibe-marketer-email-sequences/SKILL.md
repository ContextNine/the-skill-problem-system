---
name: vibe-marketer-email-sequences
version: 7.0
description: >
  Builds welcome, nurture, conversion, launch, re-engagement, post-purchase,
  onboarding, follow-up, autoresponder, and cart-abandonment email sequences.
  Use when asked for an email funnel, drip campaign, welcome series, launch
  sequence, or lead-magnet delivery flow. It applies brand voice and positioning,
  produces timed emails with subject-line variants, saves campaign files, and can
  chain to $vibe-marketer-content-atomizer for social promotion.
---
...
5. **Check for lead magnet output** (if `./campaigns/*/brief.md` or `./brand/assets.md` references a lead magnet):
   - If $vibe-marketer-lead-magnet was already run, use the actual lead magnet name, format, and delivery URL
...
├── Creative Kit      ✓ loaded
├── Lead Magnet       ✓ "{lead magnet name}" (from $vibe-marketer-lead-magnet)
└── Learnings         ✓ {N} entries
...
→ To connect an ESP, add your API key to .env
  and run $vibe-marketer-start-here to configure.
```
...
1. **What's the lead magnet?** (What did they opt in for?)
   ...
   - If $vibe-marketer-lead-magnet was already run, use those specifics instead of asking
...
Every sequence gets a `brief.md` in the campaign directory. This follows the standard campaign brief format from `references/brand-memory.md`:
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  → $vibe-marketer-creative           Build it — HTML email
  ...
  → $vibe-marketer-content-atomizer   Promote the lead magnet on
                        social (~15 min)
  → $vibe-marketer-direct-response-copy  Write the landing page
                           for the offer (~20 min)
  → $vibe-marketer-lead-magnet        Create the opt-in asset if
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  → $vibe-marketer-content-atomizer   Promote lead magnet on
                        social (~15 min)
  → $vibe-marketer-direct-response-copy  Write the offer
                           landing page (~20 min)
  → $vibe-marketer-lead-magnet        Build the opt-in asset
                        (~15 min)
...
### Chain to $vibe-marketer-content-atomizer

After generating the sequence, always suggest chaining to $vibe-marketer-content-atomizer for social promotion of the lead magnet that feeds the sequence. The atomizer can:
...
Prompt: "Your sequence is built, but it needs subscribers. Want me to create social content to promote your lead magnet and drive opt-ins? Just say $vibe-marketer-content-atomizer."

***

## Recording Feedback

After delivering the sequence, present the feedback prompt from the output template above. Process responses per `references/brand-memory.md`:

### If "Great -- shipped as-is"
- Log to `./brand/learnings.md` under "What Works":
  ```
  - [YYYY-MM-DD] [$vibe-marketer-email-sequences] {N}-part {type} sequence shipped as-is. Angle: {angle}. Tone: {tone}. Subject line style: {style that was chosen}.
  ```
...
- Log the change to `./brand/learnings.md`:
  ```
  - [YYYY-MM-DD] [$vibe-marketer-email-sequences] User {description of change}. Note: {what this implies for future sequences}.
  ```
...
- If the rewrite reveals a pattern, suggest re-running $vibe-marketer-brand-voice.
  ```
  - [YYYY-MM-DD] [$vibe-marketer-email-sequences] User rewrote {type} sequence -- shifted from {original approach} to {new approach}. Voice profile may need update.
  ```
...
- Log to `./brand/learnings.md` under "What Works" or "What Doesn't Work":
  ```
  - [YYYY-MM-DD] [$vibe-marketer-email-sequences] Subject line A/B test: "{winner}" beat "{loser}" ({open rate difference if known}). Pattern: {what the winner had that the loser didn't}.
  ```
...
- [ ] $vibe-marketer-content-atomizer suggested for lead magnet promotion
