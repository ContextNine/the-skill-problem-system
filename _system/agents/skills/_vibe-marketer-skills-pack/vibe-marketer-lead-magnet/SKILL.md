---
name: vibe-marketer-lead-magnet
version: 7.0
description: >
  Generates lead-magnet concepts and builds the selected checklist, template,
  guide, quiz, or swipe file. Use when asked for top-of-funnel ideas, list-growth
  offers, opt-in concepts, a free resource, or the finished lead-magnet content.
  It researches competing offers, connects the free asset to the paid offer,
  saves campaign files, and can chain to $vibe-marketer-direct-response-copy,
  $vibe-marketer-email-sequences, and $vibe-marketer-content-atomizer.
---
...
5. **If `./brand/` does not exist:**
   ...
   - Note: "I don't see a brand profile yet. You can run $vibe-marketer-start-here or $vibe-marketer-brand-voice first to set one up, or I'll work without it."
...
│   → $vibe-marketer-brand-voice to create one (~10 min)
```
...
When generating lead magnet concepts, present them using the numbered options template from `references/output-format.md`:
...
- Note: The actual daily emails should be created with $vibe-marketer-email-sequences
...
status: draft
created_by: $vibe-marketer-lead-magnet
...
Every lead magnet gets a `brief.md` in the campaign directory. This follows the standard campaign brief format from `references/brand-memory.md`:
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  → $vibe-marketer-creative              Build it — PDF layout, cover
                           design, or template (~15 min)
  → "Skip visuals"         Continue to funnel ↓

  ──────────────────────────────────────────────

  → $vibe-marketer-direct-response-copy  Write the landing page
                           to capture emails (~20 min)
  → $vibe-marketer-email-sequences       Build the delivery +
                           welcome sequence (~15 min)
  → $vibe-marketer-content-atomizer      Create social content to
...
**Skill:** `$vibe-marketer-direct-response-copy`
...
**Prompt:** "Your lead magnet is ready, but it needs a landing page to capture emails. Want me to write the opt-in page? Just say $vibe-marketer-direct-response-copy."

### Chain 2: Email Sequence

**Skill:** `$vibe-marketer-email-sequences`
...
**Prompt:** "Now you need emails to deliver the lead magnet and convert subscribers. Want me to build the welcome sequence? Just say $vibe-marketer-email-sequences."

### Chain 3: Social Promotion

**Skill:** `$vibe-marketer-content-atomizer`
...
**Prompt:** "Your lead magnet needs subscribers. Want me to create social content to promote it? Just say $vibe-marketer-content-atomizer."
...
```
  ...
  ② Landing Page       → $vibe-marketer-direct-response-copy
  ③ Email Sequence     → $vibe-marketer-email-sequences
  ④ Social Promotion   → $vibe-marketer-content-atomizer
...
- Offer to chain to $vibe-marketer-direct-response-copy for landing page
- Offer to chain to $vibe-marketer-email-sequences for delivery + welcome
- Offer to chain to $vibe-marketer-content-atomizer for social promotion
...
After delivering the built lead magnet, present the feedback prompt from the build mode output template. Process responses per `references/brand-memory.md`:

### If "Great -- shipped as-is"
- Log to `./brand/learnings.md` under "What Works":
  ```
  - [YYYY-MM-DD] [$vibe-marketer-lead-magnet] {format} lead magnet shipped as-is. Title: "{title}". Hook: "{hook}". Angle: {angle used}.
  ```
...
- Log the change to `./brand/learnings.md`:
  ```
  - [YYYY-MM-DD] [$vibe-marketer-lead-magnet] User edited {format} magnet. Change: {description}. Note: {implication for future magnets}.
  ```
- If edits reveal a voice mismatch, suggest: "Sounds like the voice might need tuning. Want to re-run $vibe-marketer-brand-voice?"
...
- If the rewrite reveals a pattern, suggest re-running $vibe-marketer-brand-voice.
  ```
  - [YYYY-MM-DD] [$vibe-marketer-lead-magnet] User rewrote {format} magnet significantly -- shifted from {original approach} to {new approach}. Voice profile may need update.
  ```
...
- [ ] $vibe-marketer-direct-response-copy suggested for landing page
- [ ] $vibe-marketer-email-sequences suggested for delivery + welcome sequence
- [ ] $vibe-marketer-content-atomizer suggested for social promotion
