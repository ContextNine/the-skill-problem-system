---
name: vibe-marketer-newsletter
version: 7.0
description: >
  Creates publication-ready newsletter formats and editions, including
  roundups, deep dives, personal essays, curated links, and news briefings. Use
  when asked to write or improve a newsletter, develop its format or strategy,
  plan growth or monetization, or produce a weekly roundup or briefing. It can
  research current sources, applies brand voice and audience context, saves the
  edition, and can chain to $vibe-marketer-content-atomizer.
---
...
```
Brand context loaded:
├── Voice Profile     ✗ not found (run $vibe-marketer-brand-voice)
├── Audience          ✗ not found (run $vibe-marketer-start-here)
├── Learnings         ✗ none yet
...
**This is a research-dependent skill.** When sourcing external content, show the RESEARCH MODE signal per `references/brand-memory.md`:
...
**Connection to $vibe-marketer-lead-magnet skill:** If the user has already run $vibe-marketer-lead-magnet, reference the existing asset. If not, suggest running it: "A lead magnet would give you a subscriber acquisition engine. Run $vibe-marketer-lead-magnet to create one."
...
4. Content atomized for social distribution via $vibe-marketer-content-atomizer
...
→ $vibe-marketer-content-atomizer    Atomize this edition for social
                       distribution (~5 min)
...
### What Gets Passed to $vibe-marketer-content-atomizer
...
Process feedback per `references/brand-memory.md` feedback protocol:
- Log to `./brand/learnings.md` with date, skill tag `[$vibe-marketer-newsletter]`, and specific findings
...
7. Offer next steps
   ├── → $vibe-marketer-content-atomizer (atomize for social)
...
Follow `references/output-format.md` exactly. The newsletter output should use this structure:
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  → $vibe-marketer-creative           Build it — HTML template,
  ...
  → $vibe-marketer-content-atomizer   Atomize for social (~10 min)
  → $vibe-marketer-email-sequences    Build subscriber welcome
                        sequence (~15 min)
