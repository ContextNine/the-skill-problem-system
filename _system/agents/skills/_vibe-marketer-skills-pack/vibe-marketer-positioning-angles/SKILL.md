---
name: vibe-marketer-positioning-angles
...
5. **If `./brand/` does not exist:**
   ...
   - Note in opening message: "No brand profile found — this skill works standalone. I'll ask what I need. You can run $vibe-marketer-start-here or $vibe-marketer-brand-voice later to unlock personalization."
...
Follow `references/output-format.md` strictly. All output uses the four required sections: Header, Content, Files Saved, What's Next.
...
```
  ...
  → $vibe-marketer-direct-response-copy  Write copy with your
                           winning angle (~15 min)
  → $vibe-marketer-lead-magnet           Build a lead gen
                           asset (~10 min)
  → $vibe-marketer-keyword-research      Map your content
                           territory (~15 min)
...
```markdown
## Last Updated
[Date] by $vibe-marketer-positioning-angles
...
- Suggest: "Pick 3-4 cells and I can hand them to $vibe-marketer-creative for production"
...
After delivering the final angle selection and writing to positioning.md, present the standard feedback prompt per `references/brand-memory.md`:
...
```
  ...
  $vibe-marketer-positioning-angles again and tell me.)
```

**Processing feedback:**

- **(a) Great:** Log to `./brand/learnings.md` under "What Works" with the angle name and context.
  Example: `- [2026-02-16] [$vibe-marketer-positioning-angles] "The Capability Transfer" angle shipped as-is. Stage 3 market, builder audience.`

- **(b) Good -- tweaked:** Ask what changed. Log the adjustment to learnings.md. If the tweak reveals a voice mismatch, suggest re-running $vibe-marketer-brand-voice.
