...
./brand/
  ...
  creative-kit.md         <- Written by $vibe-marketer-creative setup
  stack.md                <- Written by $vibe-marketer-start-here (tools, API keys, connected services)
...
- **If it does not exist**: skip brand loading entirely. Do not error. Proceed with the skill as if this is a first-time user and note in your opening message: "I don't see a brand profile yet. You can run $vibe-marketer-start-here or $vibe-marketer-brand-voice first to set one up, or I'll work without it."
...
| Skill | Reads |
|-------|-------|
| $vibe-marketer-brand-voice | positioning.md (if exists), audience.md (if exists) |
| $vibe-marketer-email-sequences | voice-profile.md, positioning.md, audience.md, creative-kit.md |
| $vibe-marketer-seo-content | voice-profile.md, keyword-plan.md, audience.md |
| $vibe-marketer-creative | voice-profile.md, positioning.md, creative-kit.md, stack.md |
| /competitive-intel | competitors.md (to update), positioning.md |
| $vibe-marketer-newsletter | voice-profile.md, audience.md, learnings.md |
| $vibe-marketer-lead-magnet | voice-profile.md, positioning.md, audience.md |
| $vibe-marketer-keyword-research | positioning.md, audience.md, competitors.md |
| $vibe-marketer-direct-response-copy | voice-profile.md, positioning.md, audience.md, creative-kit.md |
| $vibe-marketer-content-atomizer | voice-profile.md, creative-kit.md |
| $vibe-marketer-positioning-angles | audience.md, competitors.md |
| $vibe-marketer-start-here | ALL brand files, .env, ./campaigns/ (orchestrator needs full picture) |
...
- At the end, suggest one high-impact next step: "Running $vibe-marketer-brand-voice would give me your tone profile so I can match it next time."
...
- Use consistent markdown formatting (see schemas in `references/` for structured data).
...
Every campaign directory must have a `brief.md`. See `references/campaign-brief.schema.json` for the structured schema. The markdown version should include:
...
## What Works
- [2026-01-15] [$vibe-marketer-email-sequences] Subject lines with numbers outperform questions (62% vs 41% open rate)
- [2026-01-22] [$vibe-marketer-seo-content] Long-form guides (2500+ words) rank faster than listicles for this niche

## What Doesn't Work
- [2026-01-15] [$vibe-marketer-email-sequences] Emoji in subject lines decreased open rate by 8%
- [2026-01-20] [$vibe-marketer-creative] Stock photography feels off-brand; AI-generated with brand colors works better

## Audience Insights
- [2026-01-18] [$vibe-marketer-brand-voice] Audience responds to directness over polish -- "just tell me what to do" energy
- [2026-01-25] [$vibe-marketer-newsletter] Tuesday 7am sends outperform Thursday 10am by 23%
```
...
- Example entry: `- [2026-02-01] [$vibe-marketer-email-sequences] 6-part welcome sequence shipped as-is. Angle: social proof heavy. Tone: conversational.`
...
- Example entry: `- [2026-02-01] [$vibe-marketer-email-sequences] User softened CTA language in emails 4-6. Note: default CTAs may be too aggressive for this audience.`
...
- If the rewrite reveals a pattern (e.g., voice is consistently wrong), suggest re-running $vibe-marketer-brand-voice.
- Example entry: `- [2026-02-01] [$vibe-marketer-email-sequences] User rewrote sequence -- shifted from educational to story-driven. Voice profile may need update.`
...
> Written by $vibe-marketer-start-here. Updated when new tools are connected.
...
| Tool | Why | Setup |
|------|-----|-------|
| ConvertKit | Better creator-focused email than Mailchimp | Run $vibe-marketer-start-here to configure |
```
...
- `$vibe-marketer-keyword-research` — SERP analysis, keyword volumes, competitor rankings
- `$vibe-marketer-seo-content` — SERP gap analysis, People Also Ask, competitor content
- `$vibe-marketer-positioning-angles` — competitive landscape, market positioning
- `$vibe-marketer-newsletter` — trending topics, curated links, news briefing
...
Structured schemas for validation and interoperability live in `references/`:
...
6. **Cross-skill coherence.** A brand voice written by $vibe-marketer-brand-voice should be honored by $vibe-marketer-email-sequences, $vibe-marketer-seo-content, $vibe-marketer-newsletter, and every other skill. The brand memory is the shared source of truth.
