## Vibe Marketer Skills Pack · Architecture

**Upstream version:** v2.0 | **Date:** February 2026 | **Vault platform:** Codex manual skills
**Core system:** 11 explicit-only skills with shared, self-contained references

***

## 1. What This Is

An agentic marketing skill system for Codex that gives founders and small teams senior-level marketing output. Not prompt templates — executable methodology. Each skill embeds domain expertise, live research procedures, and decision frameworks that the active agent follows.
...
**One skill to start:** `$vibe-marketer-start-here` — the orchestrator scans project state, asks two questions, builds brand foundation, and routes to the right skill.
...
├── $vibe-marketer-start-here (orchestrator)    ├── $vibe-marketer-keyword-research
├── $vibe-marketer-brand-voice                  └── $vibe-marketer-lead-magnet
└── $vibe-marketer-positioning-angles

Layer 3: EXECUTION            Layer 4: DISTRIBUTION
├── $vibe-marketer-direct-response-copy         └── $vibe-marketer-content-atomizer
├── $vibe-marketer-seo-content
├── $vibe-marketer-email-sequences
├── $vibe-marketer-newsletter
└── $vibe-marketer-creative (5 modes)
```
...
```text
_system/agents/skills/_vibe-marketer-skills-pack/
├── README.md
├── vibe-marketer-start-here/
│   ├── SKILL.md
│   ├── references/                   # Architecture, brand memory, output format, schemas
│   └── scripts/                      # Preserved upstream packaging utilities
...
Every skill folder contains `SKILL.md` and its required `references/` resources. Folder basename and frontmatter `name` match exactly. Sync projects the skills into the flat catalog without copying their contents.

### 2.3 Skill Size Distribution

| Skill | Lines | Role |
|-------|-------|------|
| vibe-marketer-start-here | 1,858 | Orchestrator — routing, workflows, gap analysis |
| vibe-marketer-seo-content | 1,746 | Live SERP analysis + content generation |
| vibe-marketer-email-sequences | 1,737 | 6 sequence types + ESP integration |
| vibe-marketer-content-atomizer | 1,715 | 8-platform distribution engine |
| vibe-marketer-newsletter | 1,577 | 6 newsletter archetypes |
| vibe-marketer-brand-voice | 1,501 | 3 extraction modes + voice test loop |
| vibe-marketer-keyword-research | 1,498 | 6-Circles Method + content planning |
| vibe-marketer-direct-response-copy | 1,238 | Conversion copy + 7-dimension scoring |
| vibe-marketer-lead-magnet | 1,142 | 7 format types with BUILD MODE |
| vibe-marketer-positioning-angles | 767 | Competitive intel + 8 angle generators |
| vibe-marketer-creative | 531 | Entry point (bulk in modes/ and references/) |
...
```
./brand/
├── voice-profile.md      Written by: $vibe-marketer-brand-voice
├── positioning.md         Written by: $vibe-marketer-positioning-angles
├── audience.md            Written by: /audience-research (v2.1)
├── competitors.md         Written by: /competitive-intel (v2.1)
├── creative-kit.md        Written by: $vibe-marketer-creative
├── stack.md               Written by: $vibe-marketer-start-here
├── keyword-plan.md        Written by: $vibe-marketer-keyword-research
...
|-------|----------|----------|
| $vibe-marketer-brand-voice | business description, URL, content samples | keyword data, campaigns, competitors, creative kit |
| $vibe-marketer-positioning-angles | business, audience, competitors' claims, voice summary (1-2 sentences) | full voice profile, keyword plan, campaigns, email data |
| $vibe-marketer-direct-response-copy | full voice profile, chosen angle only, audience pain points | keyword plan, full competitor analysis, creative kit |
| $vibe-marketer-keyword-research | positioning angle, audience search behavior, competitor domains | voice profile, creative kit, email data, campaigns |
| $vibe-marketer-seo-content | full voice profile, target keyword + brief, audience expertise level | positioning (unless product article), email data, creative kit |
| $vibe-marketer-email-sequences | full voice profile, positioning angle, audience awareness level, lead magnet details, creative kit summary | keyword plan, full SEO content, full competitor analysis |
| $vibe-marketer-lead-magnet | voice tone + vocabulary, positioning angle, audience pain points | keyword plan, email history, creative kit, competitor depth |
| $vibe-marketer-newsletter | full voice profile, audience interests, engagement learnings | positioning, keyword plan, competitor analysis, campaigns |
| $vibe-marketer-content-atomizer | voice platform-adaptation table, source content, creative kit summary | full positioning, keyword plan, email data, campaigns |
| $vibe-marketer-creative | voice summary, positioning angle, full creative kit, stack.md | keyword plan, email data, full audience, competitor analysis |
| $vibe-marketer-start-here | ALL files | (nothing — orchestrator needs full picture) |
...
2. Dispatch $vibe-marketer-brand-voice and $vibe-marketer-positioning-angles as parallel task agents
...
|----------|---------|-------|
| Starting from Zero | First run / "help me set up" | $vibe-marketer-brand-voice + $vibe-marketer-positioning-angles (parallel) → goal routing |
| I Have an Idea | "launch this" / "new product" | $vibe-marketer-positioning-angles → $vibe-marketer-direct-response-copy → $vibe-marketer-lead-magnet |
| I Need Leads | "build my list" / "lead magnet funnel" | $vibe-marketer-lead-magnet → $vibe-marketer-direct-response-copy → $vibe-marketer-email-sequences → $vibe-marketer-content-atomizer |
| Content Strategy | "content plan" / "what should I write about" | $vibe-marketer-keyword-research → $vibe-marketer-seo-content → $vibe-marketer-content-atomizer → $vibe-marketer-newsletter |
| Launching Something | "product launch" / "launch campaign" | $vibe-marketer-positioning-angles → $vibe-marketer-direct-response-copy → $vibe-marketer-email-sequences → $vibe-marketer-content-atomizer → $vibe-marketer-creative |
| Start Newsletter | "newsletter" / "weekly email" | $vibe-marketer-newsletter (standalone or with $vibe-marketer-brand-voice first) |
| Creative Campaign | "visual campaign" / "brand shoot" | $vibe-marketer-creative (with brand kit setup if needed) |
...
Every skill is designed to be invoked directly without any prior context. A user who types `$vibe-marketer-email-sequences` and has never used the system before gets a working email sequence. Brand memory enhances output — it doesn't gate it.
...
All output follows a terminal-native design system defined in `references/output-format.md`:
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  → $vibe-marketer-positioning-angles   Find your competitive angle (~10 min)
  → $vibe-marketer-lead-magnet          Build a list-growing asset (~15 min)
...
|--------|-----------|-------------|---------|
| voice-profile | $vibe-marketer-brand-voice | All content skills | Tone spectrum, vocabulary, personality traits, platform adaptations |
| campaign-brief | Any skill starting a campaign | $vibe-marketer-start-here, downstream skills | Campaign metadata, asset tracking, results |
| keyword-plan | $vibe-marketer-keyword-research | $vibe-marketer-seo-content, $vibe-marketer-start-here | Clusters with priority, volume, difficulty, intent |
| email-sequence-summary | $vibe-marketer-email-sequences | ESP automation | Sequence structure, subject line variants, send timing |
| ad-matrix | $vibe-marketer-positioning-angles, $vibe-marketer-creative | Ad platforms, $vibe-marketer-creative | 12-cell hook x format testing matrix with performance tracking |
| content-brief | $vibe-marketer-keyword-research | $vibe-marketer-seo-content | SERP analysis, recommended structure, target metrics |
...
The upstream `doctor.sh` and `e2e-fresh-install.sh` utilities are preserved with the orchestrator for provenance. They describe the original standalone Claude package and are not the vault installation authority.

### 8.4 Packaging

`package.sh` preserves the upstream zip workflow for reference. The canonical Vault source is `_system/agents/skills/_vibe-marketer-skills-pack`, and the generated `_system/agents/skills/catalog/` contains symlinks only.
...
Skills are primarily Markdown instructions and bundled references, not an application runtime. Codex reads and follows the instructions. This means:
...
- **Pro:** The skills remain human-readable and portable across compatible agent surfaces
- **Con:** No programmatic enforcement of the Context Matrix — the active agent must follow instructions
...
The output format system uses Unicode box-drawing characters instead of Markdown. This retains the upstream terminal-oriented presentation and encourages concise formatting.
...
*This document preserves the upstream Vibe Marketing Skills v2.0 architecture while documenting the vault-native manual-skill layout. The canonical source is `_system/agents/skills/_vibe-marketer-skills-pack/`.*
