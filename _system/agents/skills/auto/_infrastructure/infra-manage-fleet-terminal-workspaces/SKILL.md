...
- Use `$infra-code-folder-and-computer-topology` and `ctx9-agents config` to load the canonical machine registry and private execution-chain observations. Do not duplicate machine IDs, aliases, homes, roots or routes in this skill.
