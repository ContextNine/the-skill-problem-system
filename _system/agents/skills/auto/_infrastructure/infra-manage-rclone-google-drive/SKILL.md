---
name: infra-manage-rclone-google-drive
...
3. Stop on missing Rclone, desired IDs, native credentials, or explicit approval. Use `$infra-update-fleet-dependencies` for installation and `$infra-onboard-machine` for credential enrollment.
