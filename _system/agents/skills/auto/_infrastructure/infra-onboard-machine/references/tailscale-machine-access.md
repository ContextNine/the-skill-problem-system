...
```bash
tailscale_setup="$(vault root)/_system/agents/skills/auto/_infrastructure/infra-onboard-machine/scripts/setup_tailscale_access.py"
...
```bash
helper="$(vault root)/_system/agents/skills/auto/_infrastructure/infra-onboard-machine/scripts/trust_known_host_alias.py"
