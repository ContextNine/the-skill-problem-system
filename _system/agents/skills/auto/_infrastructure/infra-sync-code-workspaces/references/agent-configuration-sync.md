...
|---|---|
| Machine identity, role, platform, home, transport, eligibility | `_system/agents/_package/instance/fleet/machines.json` |
...
```bash
SKILL_DIR="$(vault root)/_system/agents/skills/auto/_infrastructure/infra-sync-code-workspaces"
