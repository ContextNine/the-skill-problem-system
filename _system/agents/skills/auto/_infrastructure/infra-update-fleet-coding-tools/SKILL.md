...
This skill is the coding-tool specialist used by [[_system/agents/skills/auto/_infrastructure/infra-update-fleet-dependencies/SKILL|Update Fleet Dependencies]]. Execute through the shared implementation:
...
Read [[_system/agents/skills/auto/_infrastructure/infra-code-folder-and-computer-topology/SKILL|Code Folder and Computer Topology]] and every prerequisite it requires before connecting to or changing a machine.
...
6. For an installed macOS nightly app, follow [[_system/agents/skills/auto/_infrastructure/infra-update-fleet-coding-tools/references/native-artifact-updates|Native Artifact Updates]]. Use its configured GitHub nightly channel and the same exact version resolved above.
