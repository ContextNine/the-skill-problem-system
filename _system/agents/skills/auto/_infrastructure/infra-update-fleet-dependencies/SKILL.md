---
name: infra-update-fleet-dependencies
...
- Invoke [[_system/agents/skills/auto/_infrastructure/infra-update-fleet-coding-tools/SKILL|Update Fleet Coding Tools]] whenever `--coding-tools` is selected. It owns Codex provenance, exact T3 nightly alignment, native artifact acceptance, and service-manager handling.
