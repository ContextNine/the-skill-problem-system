...
metadata:
    ...
    category: seo
    github-path: skills/seo-content-brief
    github-ref: refs/tags/v2.2.5
    github-repo: https://github.com/AgriciDaniel/claude-seo
    github-tree-sha: 3b8585d2de2ee3d6036f9058cb613db645ec9a15
    original_author: puneetindersingh
    version: 1.0.0
name: claude-seo-content-brief
user-invocable: true
---
# Claude · SEO Content Brief Generator
