...
metadata:
    author: AgriciDaniel
    category: seo
    github-path: skills/seo-flow
    github-ref: refs/tags/v2.2.5
    github-repo: https://github.com/AgriciDaniel/claude-seo
    github-tree-sha: de1dab57b586481ce18f35ea4dee5302dcc5dc2e
    version: 2.2.5
name: claude-seo-flow
user-invocable: true
---
# Claude · FLOW Framework: Find · Leverage · Optimize · Win
