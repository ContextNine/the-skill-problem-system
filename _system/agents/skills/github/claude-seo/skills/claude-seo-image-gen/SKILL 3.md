...
metadata:
    author: AgriciDaniel
    category: seo
    github-path: skills/seo-image-gen
    github-ref: refs/tags/v2.2.5
    github-repo: https://github.com/AgriciDaniel/claude-seo
    github-tree-sha: c7d87c0d0dc95d987f5c01b87947fd29eb130112
    version: 2.2.5
name: claude-seo-image-gen
user-invocable: true
---
# Claude · SEO Image Gen: AI Image Generation for SEO Assets (Extension)
