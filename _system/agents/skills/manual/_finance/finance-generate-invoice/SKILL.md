...
3. Read `outsource-think/_finance/AGENTS.md` before generating into the canonical invoice folder. The selected invoice mode controls the legal issuer and taxpayer; folder location alone does not.
