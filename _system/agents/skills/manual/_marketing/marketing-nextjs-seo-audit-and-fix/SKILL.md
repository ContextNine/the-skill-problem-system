...
6. Hand GTM, GA4, Consent Mode, and data-layer work to [[_system/agents/skills/manual/_marketing/marketing-google-marketing-measurement/SKILL|Google Marketing Measurement]]. Hand managed campaign URLs to [[_system/agents/skills/manual/_marketing/marketing-manage-utm-tracking-links/SKILL|Manage UTM Tracking Links]].
