> Adapted from [web-quality-skills](https://github.com/addyosmani/web-quality-skills/blob/95d6e255afe1596b557d7a8498517884438f5b3a/skills/accessibility/references/A11Y-PATTERNS.md) at commit `95d6e255afe1596b557d7a8498517884438f5b3a`. Retained under the upstream MIT license; see [provenance and license](provenance-and-license.md).

# Accessibility Code Patterns

## Contents

Modal focus trap; skip link; error handling; form labels; dragging movements; ARIA tabs; live regions and notifications; screen-reader commands.
