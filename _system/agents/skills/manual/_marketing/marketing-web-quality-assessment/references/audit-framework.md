> Adapted from [web-quality-skills](https://github.com/addyosmani/web-quality-skills/tree/95d6e255afe1596b557d7a8498517884438f5b3a/skills/web-quality-audit) at commit `95d6e255afe1596b557d7a8498517884438f5b3a`. Retained under the upstream MIT license; see [provenance and license](provenance-and-license.md).
...
Audit workflow; categories; severity levels; output format; results template; quick checklist; references.
