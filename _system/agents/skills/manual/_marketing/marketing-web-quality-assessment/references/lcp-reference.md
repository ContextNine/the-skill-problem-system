> Adapted from [web-quality-skills](https://github.com/addyosmani/web-quality-skills/blob/95d6e255afe1596b557d7a8498517884438f5b3a/skills/core-web-vitals/references/LCP.md) at commit `95d6e255afe1596b557d7a8498517884438f5b3a`. Retained under the upstream MIT license; see [provenance and license](provenance-and-license.md).

# LCP optimization reference

## Contents

LCP definition; timeline; detailed optimizations; framework tips; debugging; common issues.
