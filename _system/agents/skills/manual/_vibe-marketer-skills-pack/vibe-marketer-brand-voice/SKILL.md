---
name: vibe-marketer-brand-voice
description: >
...
4. If files are missing, proceed without them. Note at the end:
   ```
   → $vibe-marketer-positioning-angles would sharpen this profile
...
```
  ...
  ① Save current version (you can always re-run
     $vibe-marketer-brand-voice to update)
...
```markdown
## Last Updated
{YYYY-MM-DD} by $vibe-marketer-brand-voice
...
```json
{
  ...
  "updated_by": "$vibe-marketer-brand-voice",
  "tone": {
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  → $vibe-marketer-positioning-angles   Find your market angle (~10 min)
  → $vibe-marketer-direct-response-copy Write your first landing
                          page (~15 min)
  → $vibe-marketer-start-here           See full project status
...
## Last Updated
2026-02-16 by $vibe-marketer-brand-voice
...
3. Include the `## Last Updated` line at the top with today's date and
   `$vibe-marketer-brand-voice` as the author.
...
**The workflow:**
1. Run $vibe-marketer-brand-voice first (Extract, Build, or Auto-Scrape)
...
- Feedback from $vibe-marketer-email-sequences or $vibe-marketer-direct-response-copy suggests the
...
```
  ...
  (You can answer later — just run $vibe-marketer-brand-voice
  again and tell me.)
```
...
- Log to ./brand/learnings.md under "What Works":
  `- [{date}] [$vibe-marketer-brand-voice] Voice profile shipped as-is. Mode: {mode}. Key traits: {traits}.`
...
- Next time $vibe-marketer-brand-voice runs, remind: "Last time I built your voice
...
This is the full decision tree for every $vibe-marketer-brand-voice invocation:

```
  $vibe-marketer-brand-voice invoked
  │
