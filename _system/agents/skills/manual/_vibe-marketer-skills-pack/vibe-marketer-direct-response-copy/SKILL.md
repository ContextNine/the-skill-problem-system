---
name: vibe-marketer-direct-response-copy
version: 7.0
...
Follow `references/output-format.md` -- all 4 required sections.
...
──────────────────────────────────────────────────
  ...
  → $vibe-marketer-creative            Build this — landing page,
  ...
  → $vibe-marketer-email-sequences     Build a nurture sequence
                         around this page (~15 min)
  → $vibe-marketer-content-atomizer    Break into social posts,
                         email snippets, ad hooks (~10 min)
  → $vibe-marketer-lead-magnet         Create a lead magnet for the
                         top of this funnel (~10 min)
  → $vibe-marketer-keyword-research    Find search terms to drive
