---
name: vibe-marketer-keyword-research
description: >
...
4. If files are missing, proceed without them. Note at the end:
   ```
   → $vibe-marketer-positioning-angles would sharpen keyword alignment
...
2. Present a summary of the current keyword strategy:
   ...
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
     ...
     Last updated {date} by $vibe-marketer-keyword-research
...
## Last Updated
{YYYY-MM-DD} by $vibe-marketer-keyword-research
...
format specification from `references/output-format.md`. The terminal output
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Per references/brand-memory.md: always show the research
  ...
  → $vibe-marketer-seo-content        Write your first article
                         with your top cluster (~20 min)
  → $vibe-marketer-content-atomizer   Repurpose across social
                         channels (~10 min)
  → $vibe-marketer-newsletter         Build an edition around
...
## Chain to $vibe-marketer-seo-content
...
```
  ...
  I can write this article now using $vibe-marketer-seo-content.
  It will use your brand voice, the content brief,
  and the SERP data I just gathered.

  → "Write it" to start $vibe-marketer-seo-content now
  → "Not yet" to save the plan and stop here

  ──────────────────────────────────────────────
```

If the user says "write it" or similar, hand off to $vibe-marketer-seo-content with:
...
- Content writing (use $vibe-marketer-seo-content skill after brief generation)
...
is handled by $vibe-marketer-seo-content and other downstream skills.
...
Then:
- **$vibe-marketer-seo-content** --> Writes individual articles using the content briefs
- **$vibe-marketer-positioning-angles** --> Finds the angle for each piece (or informs keyword selection)
- **$vibe-marketer-brand-voice** --> Ensures consistent voice across all content
- **$vibe-marketer-direct-response-copy** --> Writes landing pages for commercial-intent keywords
- **/competitive-intel** --> Deep-dives into competitor strategy (feeds back into gap analysis)
- **$vibe-marketer-content-atomizer** --> Repurposes pillar content into social, email, etc.
- **$vibe-marketer-lead-magnet** --> Creates lead magnets aligned with top-of-funnel keywords
...
This is the full decision tree for every $vibe-marketer-keyword-research invocation:

```
  $vibe-marketer-keyword-research invoked
  │
  ...
  │   ├── FILES SAVED
  │   └── WHAT'S NEXT (with $vibe-marketer-seo-content chain offer)
  │
  ├── Chain offer: Write top article with $vibe-marketer-seo-content?
  │
  └── Feedback Collection
...
7. **Executable** -- Content briefs ready to hand to $vibe-marketer-seo-content
...
```
  ...
  $vibe-marketer-keyword-research again and tell me.)
```
...
- Log to ./brand/learnings.md under "What Works":
  `- [{date}] [$vibe-marketer-keyword-research] Keyword plan shipped as-is. {N} pillars, {N} briefs. Key finding: {top discovery from web search}.`
...
- Next time $vibe-marketer-keyword-research runs, remind: "Last time I built a keyword plan with {N} briefs. Have you started writing? I can help with $vibe-marketer-seo-content."
...
references/brand-memory.md. Tell the user you are using estimated data based on
...
```
  ...
  │  → $vibe-marketer-start-here to build your full profile    │
  │  → $vibe-marketer-brand-voice to start with voice          │
  │                                              │
  └──────────────────────────────────────────────┘
```
...
9. **The chain to $vibe-marketer-seo-content is the handoff.** Always offer it. The
   keyword plan is strategy. $vibe-marketer-seo-content is execution. The faster the
