...
```text
_system/agents/skills/manual/_vibe-marketer-skills-pack/
├── README.md
...
`package.sh` preserves the upstream zip workflow for reference. The canonical Vault source is `_system/agents/skills/manual`, and the generated `_system/agents/skills/catalog/` contains symlinks only.
...
*This document preserves the upstream Vibe Marketing Skills v2.0 architecture while documenting the vault-native manual-skill layout. The canonical source is `_system/agents/skills/manual/_vibe-marketer-skills-pack/`.*
