...
Edit `edit/agent-instructions/AGENT-INSTRUCTIONS.md` for shared instructions and the flat `templates/` folder for machine and development variants. Read `edit/agent-instructions/README.md` for the current composition order and edit commands. The renderer configuration and public starter base live under `internal/instructions/`.
