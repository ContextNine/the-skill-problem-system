---
name: code-i-audit-repo-security
...
```bash
python3 "$(vault root)/_system/agents/edit/skills/_code/code-i-audit-repo-security/scripts/audit_repo_security.py" .
```
