...
Never use mount failure as permission to create a clone, sparse checkout, copied publication tree, or broader home mount. Setup and recovery belong to Linux Remote Vault Access through `$fleet-i-onboard-machine`.
