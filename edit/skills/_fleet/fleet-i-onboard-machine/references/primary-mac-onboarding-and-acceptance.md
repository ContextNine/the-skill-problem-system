...
9. Run `$fleet-i-sync-code-workspaces` in preview and doctor modes against reachable reviewed workers; do not force a fleet rollout merely to accept the primary.
