...
```bash
tailscale_setup="$(vault root)/_system/agents/edit/skills/_fleet/fleet-i-onboard-machine/scripts/setup_tailscale_access.py"
...
```bash
helper="$(vault root)/_system/agents/edit/skills/_fleet/fleet-i-onboard-machine/scripts/trust_known_host_alias.py"
