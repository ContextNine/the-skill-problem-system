...
This is the worker-Mac branch of `$fleet-i-onboard-machine`. `$fleet-i-manage-terminal-workspaces` owns Warp, cmux, terminal profiles, workmux, and T3 SSH terminal integration. `$fleet-i-sync-code-workspaces` owns Code repositories and personal Codex and Claude configuration. Do not duplicate those procedures here.
...
```bash
python3 "$(vault root)/_system/agents/edit/skills/_fleet/fleet-i-onboard-machine/scripts/bootstrap_worker_mac.py" finish MACHINE_ID
python3 "$(vault root)/_system/agents/edit/skills/_fleet/fleet-i-onboard-machine/scripts/bootstrap_worker_mac.py" finish MACHINE_ID
```
...
```bash
python3 "$(vault root)/_system/agents/edit/skills/_fleet/fleet-i-onboard-machine/scripts/bootstrap_worker_mac.py" verify MACHINE_ID --json
```
