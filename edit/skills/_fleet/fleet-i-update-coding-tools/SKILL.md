---
name: fleet-i-update-coding-tools
...
# Fleet · Update Fleet Coding Tools

## Shared command

This skill is the coding-tool specialist used by [Update Fleet Dependencies](../fleet-i-update-dependencies/SKILL.md). Execute through the shared implementation:
...
Read [Code Folder and Computer Topology](../fleet-i-code-folder-and-computer-topology/SKILL.md) and every prerequisite it requires before connecting to or changing a machine.
