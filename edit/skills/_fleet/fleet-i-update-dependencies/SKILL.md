---
name: fleet-i-update-dependencies
...
- Invoke [Update Fleet Coding Tools](../fleet-i-update-coding-tools/SKILL.md) whenever `--coding-tools` is selected. It owns Codex provenance, exact T3 nightly alignment, native artifact acceptance, and service-manager handling.
