...
Dependency ID: `t3-code`. It uses nightly releases. One fleet operation resolves one exact version, then aligns selected installed CLI/server or macOS desktop artifacts to that version through fleet-i-update-coding-tools.
