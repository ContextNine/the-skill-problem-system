...
1. Read [[README-primary-worker-vault-sync|Primary and Worker Vault Coordination]], the topology observations README, `_system/agents/edit/settings/fleet/machines.json`, `_system/agents/edit/settings/fleet/workspaces.json`, and `_system/agents/edit/settings/dependencies/selections.json`.
