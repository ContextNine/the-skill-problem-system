...
1. Read `_system/agents/edit/settings/skills/config/marketing-google-marketing-measurement/README.md`; resolve the target repository through topology config.
...
```bash
SKILL_DIR="$(vault root)/_system/agents/edit/skills/_marketing/marketing-google-marketing-measurement"
