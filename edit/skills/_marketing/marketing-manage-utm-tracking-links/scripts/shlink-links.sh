...
CONFIG_PATH="${CONFIG_PATH:-$VAULT_ROOT/_system/agents/edit/settings/skills/config/marketing-manage-utm-tracking-links/private/config.json}"
...
REPOSITORY_REGISTRY="$VAULT_ROOT/_system/agents/edit/settings/fleet/workspaces.json"
