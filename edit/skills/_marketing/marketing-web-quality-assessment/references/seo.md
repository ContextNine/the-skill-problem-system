> Adapted from [web-quality-skills](https://github.com/addyosmani/web-quality-skills/tree/95d6e255afe1596b557d7a8498517884438f5b3a/skills/seo) at commit `95d6e255afe1596b557d7a8498517884438f5b3a`. Retained under the upstream MIT license; see [provenance and license](provenance-and-license.md).
...
Fundamentals; technical SEO; on-page SEO; structured data; AI-search visibility; mobile SEO; international SEO; audit checklist; tools; references.
...
| Technical SEO | ~15% | ✓ |
| Page experience (Core Web Vitals) | ~10% | See [Core Web Vitals](core-web-vitals.md) |
| On-page SEO | ~10% | ✓ |
