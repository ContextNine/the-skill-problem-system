> Adapted from [web-quality-skills](https://github.com/addyosmani/web-quality-skills/blob/95d6e255afe1596b557d7a8498517884438f5b3a/skills/accessibility/references/WCAG.md) at commit `95d6e255afe1596b557d7a8498517884438f5b3a`. Retained under the upstream MIT license; see [provenance and license](provenance-and-license.md).

# WCAG 2.2 Quick Reference

## Contents

Success criteria by level; common ARIA patterns; WCAG 2.2 changes; testing tools; sources.
