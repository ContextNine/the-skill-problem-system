# Set up a CRM and GTM workspace
...
Run `scripts/apply.py` from this skill bundle while keeping the working directory inside the Vault. It is dry-run by default and copies only missing files:
