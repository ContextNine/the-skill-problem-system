...
PACKAGE_STATE = Path(".agents/state/reference-package.json")
PACKAGE_ROOT = Path(".agents")
...
def validate_manifest(
    ...
    for dependency in dependencies:
        ...
        if not isinstance(lifecycle_doc, str) or not lifecycle_doc.startswith("dependencies/") or ".." in PurePosixPath(lifecycle_doc).parts:
