...
def update(args: argparse.Namespace) -> int:
    ...
    registry_path = (args.machine_registry or agents / "edit/settings/fleet/machines.json").expanduser().resolve()
    ...
    manifest_path = agents / "internal/defaults/dependencies.json"
    ...
    if "skills" in parts:
        source_config = read_json(agents / "edit/settings/skills/skill-sources.json", "skill-source config")
    ...
    if "skills" in parts:
        ...
        skill_source_update.atomic_write_lock(agents / "internal/generated/state/skills.lock.json", skill_lock)
